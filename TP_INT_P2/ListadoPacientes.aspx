...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvPacientes" runat="server" 
        ...
        CellPadding="10" CellSpacing="5" GridLines="None" OnRowDeleting="gvPacientes_RowDeleting" OnDataBound="gvPacientes_DataBound" OnRowCancelingEdit="gvPacientes_RowCancelingEdit" OnRowDataBound="gvPacientes_RowDataBound" OnRowEditing="gvPacientes_RowEditing" OnRowUpdating="gvPacientes_RowUpdating" AllowPaging="True" OnPageIndexChanging="gvPacientes_PageIndexChanging">
        <Columns>
